...
//     void* permanent_storage; // NOTE(casey): REQUIRED to be cleared to zero
//     at startup
//
//     u64 transient_storage_size;
//     void* transient_storage; // NOTE(casey): REQUIRED to be cleared to zero
//     at startup
// };
//
...
// Game_Memory* memory, Game_Sound_Output_Buffer* sound_buffer)
//*/
//
//
...
//     ray_state.total_size = game_memory.permanent_storage_size +
//     game_memory.transient_storage_size; ray_state.game_memory_block =
//     MemRealloc(base_address, ray_state.total_size);
...
//     buffer.memory = MemAlloc(buffer.width * buffer.height *
//     buffer.bytes_per_pixel); if (buffer.memory) {
//         // success
//     //
//     } else {
...
//         //Controller
//         //----------------------------------------------------------------------------------
//         for (int controller_index = 0; controller_index <
//         MAX_CONTROLLER_COUNT; controller_index++) {
...
//             game_code.get_sound_samples_fn(&thread, &game_memory,
//             &sound_buffer);
//         }
//         if (game_code.update_and_render_fn) {
//             game_code.update_and_render_fn(&thread, &game_memory, new_input,
//             &buffer);
//         }
...
//
//             DrawText(TextFormat("DETECTED AXIS [%i]:",
//             GetGamepadAxisCount(0)), 10, 50, 10, MAROON);
//
//             for (int i = 0; i < GetGamepadAxisCount(0); i++) {
//                 DrawText(TextFormat("AXIS %i: %.02f", i,
//                 GetGamepadAxisMovement(0, i)), 20, 70 + 20*i, 10, DARKGRAY);
//             }
//
//             if (GetGamepadButtonPressed() != GAMEPAD_BUTTON_UNKNOWN)
//             DrawText(TextFormat("DETECTED BUTTON: %i",
//             GetGamepadButtonPressed()), 10, 430, 10, RED);
//
