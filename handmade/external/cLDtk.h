...
extern JSON_Array*
    levels_layerInstances_entityInstances_fieldInstances_realEditorValues;
extern JSON_Array*
    levels_layerInstances_entityInstances_fieldInstances_realEditorValues_params;
...
extern struct fieldInstances_points {
  ...
  int cy;
  signed char
      check; // Cheat check to handle NULL values until I find a better way
  int size;
...
extern struct fieldInstances {
  ...
  int defUid;
  int size;
} fieldInstances, *fieldInstances_details_ptr, *fieldInstances_points_ptr,
    *fieldInstances_floats_ptr, *fieldInstances_ints_ptr,
    *fieldInstances_strings_ptr;
//----------------------------------------------------------------
...
} layerInstances, *layerInstances_details_ptr, *autoTiles_data_ptr,
    *gridTiles_data_ptr, *entityInstances_data_ptr, *integerGrid_data_ptr;
//----------------------------------------------------------------
...
} levels, *levels_details_ptr, *layers_data_ptr, *tilesets_data_ptr,
    *enums_data_ptr;
//----------------------------------------------------------------
...
static const char* fieldInstance_localEnum __attribute__((unused)) =
    "LocalEnum"; // 9 chars
...
// array value checks
static const char* fieldInstance_array_int __attribute__((unused)) =
    "Array<Int>";
static const char* fieldInstance_array_float __attribute__((unused)) =
    "Array<Float>";
static const char* fieldInstance_array_boolean __attribute__((unused)) =
    "Array<Bool>";
static const char* fieldInstance_array_string __attribute__((unused)) =
    "Array<String>";
static const char* fieldInstance_array_localEnum __attribute__((unused)) =
    "Array<LocalEnum"; // 15 chars
static const char* fieldInstance_array_point __attribute__((unused)) =
    "Array<Point>";
static const char* fieldInstance_array_color __attribute__((unused)) =
    "Array<Color>";
static const char* fieldInstance_array_filePath __attribute__((unused)) =
    "Array<FilePath>";
