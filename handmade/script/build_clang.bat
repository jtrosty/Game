...
set CommonCompilerFlags=-std=c++14 -D HANDMADE_INTERNAL -D HANDMADE_SLOW -D CLANG_COMPILE
...
clang++ %CommonCompilerFlags% -c /src/core.cpp -o core_clang.dll -MJ clangd_dll.json -g %LinkerFlags% %IncludeFlags%
clang++ %CommonCompilerFlags% /src/win32_platform.cpp -o coreGame.exe -MJ clangd_final.json -g %LinkerFlags% %IncludeFlags%
